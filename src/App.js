  ...
  render() {
    return (
      <main className='App'>
        ...
        <label htmlFor='value'>Numerical value to Search:</label>
        <input type='text' name="value" id="value" onChange={e => this.updateValue(e.target.value)} />
        <LinearSearch searchValue={this.state.value} />
        <BinarySearch searchValue={this.state.value} array={this.array}/>
      </main>
    )
  }
}
